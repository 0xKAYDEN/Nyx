...
public class StandalonePool : IDisposable
{
  ...
  public StandalonePool(int minimumPoolSize = 6, int maximumPoolSize = 32 /*0x20*/)
  {
  ...
  ~StandalonePool() => this.method_2(false);
  ...
  internal void method_6()
  {
    int int2 = this.int_2;
    int int0 = this.int_0;
    if ((int2 == int0 || this.queue_0.Count / 10 >= int0) && int0 < this.int_4)
      this.method_0();
    if (int2 > int0 / 4 || int0 <= this.int_3)
      return;
    this.method_1();
  }
