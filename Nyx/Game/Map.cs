...
namespace Nyx.Server.Game
{
    public class Map
    {
        ...
        public static Counter DynamicIDs = new Nyx.Server.Counter(11000) { Finish = 60000 };
        ...
        public Counter EntityUIDCounter = new Nyx.Server.Counter(400000);
        public Counter EntityUIDCounter2 = new Nyx.Server.Counter(100000);
        ...
        public void LoadMonsters()
        {
            try
            {
                this.BodyGuards = new SafeDictionary<uint, Entity>(1000);
                Companions = new SafeDictionary<uint, Entity>();
                using (var command = new Database.MySqlCommand(Database.MySqlCommandType.SELECT))
                {
        ...
        public static void CreateTimerFactories()
        {
            ...
            using (var cmd = new Database.MySqlCommand(Database.MySqlCommandType.SELECT).Select("Furniture").Where("lookface", 8200))
