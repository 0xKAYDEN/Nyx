...
namespace Nyx.Server.Game.ConquerStructures.Society
{
    ...
    {
        #region Roses
        public static byte[] BuildPacketRedRosseDonaionPage1(Client.GameClient client, byte Subtype, byte pagenumber)
        {
        ...
        #endregion
        #region Lilise
        public static byte[] BuildPacketLiliseDonaionPage1(Client.GameClient client, byte Subtype, byte pagenumber)
        {
            MemoryStream strm = new MemoryStream();
            BinaryWriter wtr = new BinaryWriter(strm);
            wtr.Write((ushort)0);
        ...
        #endregion
        #region Tuplise
        public static byte[] BuildPacketTupliseDonaionPage1(Client.GameClient client, byte Subtype, byte pagenumber)
        {
            MemoryStream strm = new MemoryStream();
            BinaryWriter wtr = new BinaryWriter(strm);
            wtr.Write((ushort)0);
        ...
        #endregion
        #region Orchades
        public static byte[] BuildPacketOrchadesDonaionPage1(Client.GameClient client, byte Subtype, byte pagenumber)
        {
            MemoryStream strm = new MemoryStream();
            BinaryWriter wtr = new BinaryWriter(strm);
            wtr.Write((ushort)0);
        ...
        public static byte[] BuildPacketGuideDonaionPage1(Client.GameClient client, byte Subtype, byte pagenumber)
        {
            MemoryStream strm = new MemoryStream();
            BinaryWriter wtr = new BinaryWriter(strm);
            wtr.Write((ushort)0);
        ...
        #endregion
        #region CpDoantion
        public static byte[] BuildPacketCpDonaionPage1(Client.GameClient client, byte Subtype, byte pagenumber)
        {
            MemoryStream strm = new MemoryStream();
            BinaryWriter wtr = new BinaryWriter(strm);
            wtr.Write((ushort)0);
