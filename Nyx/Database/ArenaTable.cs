...
namespace Nyx.Server.Database
{
    public class ArenaTable
    {
        ...
        public static void SaveArenaStatistics(Network.GamePackets.ArenaStatistic stats, Network.GamePackets.ChampionPoints CP, MySql.Data.MySqlClient.MySqlConnection conn)
        {
