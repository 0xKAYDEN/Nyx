    ...
    public class SkillTable
    {
        ...
        public static void LoadProficiencies(GameClient client)
        {
            ...
            if (client.Entity != null)
            {
                ...
                MySqlReader reader = new MySqlReader(new Nyx.Server.Database.MySqlCommand(MySqlCommandType.SELECT).Select("profs").Where("EntityID", (long)client.Entity.UID));
                while (reader.Read())
                {
        ...
        public static void LoadSpells(GameClient client)
        {
            ...
            if (client.Entity != null)
            {
                ...
                MySqlReader reader = new MySqlReader(new Nyx.Server.Database.MySqlCommand(MySqlCommandType.SELECT).Select("skills").Where("EntityID", (long)client.Entity.UID));
                while (reader.Read())
                {
        ...
        public static void SaveProficiencies(GameClient client)
        {
            ...
            if (((client.Entity != null) && (client.Proficiencies != null)) && (client.Proficiencies.Count != 0))
            {
                ...
                {
                    Nyx.Server.Database.MySqlCommand command;
                    if (prof.Available)
                    {
                        if (prof.PreviousLevel != prof.Level)
                        {
                            command = new Nyx.Server.Database.MySqlCommand(MySqlCommandType.UPDATE);
                    ...
                    {
                        prof.Available = true;
                        command = new Nyx.Server.Database.MySqlCommand(MySqlCommandType.INSERT);
