...
namespace Nyx.Server.Database
{
    public class ClaimItemTable
    {
        ...
        {
            using (var cmd = new Database.MySqlCommand(Database.MySqlCommandType.SELECT).Select("claimitems").Where("GainerUID", client.Entity.UID))
        ...
        {
            using (var command = new Database.MySqlCommand(Database.MySqlCommandType.DELETE))
